...
Next, we need normality, which assumes that the residuals are normally distributed. For this, we performed many Wilk-Shapiro tests- we did this continually as we tried to fit an appropriate model. We eventually settled on a model that included transformations, interaction effects, and a pruned-down set of predictors. Despite this, we were only able to get p-values of $4.42e-13$ and $1.06e-9$ for the heating and cooling models, respectively.
